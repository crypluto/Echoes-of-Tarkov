...
class TraderTemplate {
    ...
    postDBLoad(container) {
        ...
        traderData.addTraderToLocales(this.ref.tables, baseJson.name, "Doc", baseJson.nickname, baseJson.location, "A blunt, sardonic former trauma surgeon turned black market medical trader, Doc uses his unmatched skills and sharp wit to keep the desperate alive in the ruins of Tarkov—for a price.");
        console.log(`\x1b[94m[Echoes of Tarkov] \x1b[93m Doc Loaded          | The patient needs mousebites to live`);
    }
}
