...
class TraderTemplate implements IPreSptLoadMod, IPostDBLoadMod {
	...
	public postDBLoad(container: DependencyContainer): void {
		...
		traderData.addTraderToLocales(this.ref.tables,
			...
			baseJson.nickname,
			baseJson.location,
			"A blunt, sardonic former trauma surgeon turned black market medical trader, Doc uses his unmatched skills and sharp wit to keep the desperate alive in the ruins of Tarkov—for a price."
		)
